...
class _ProductCardState extends State<ProductCard> {
  ...
  Widget build(BuildContext context) {
    return Builder(
      builder: (context) {
        ...
        return SizedBox(
          width: isSmallScreen ? MediaQuery.sizeOf(context).width : 400,
          height: isSmallScreen ? MediaQuery.sizeOf(context).height : null,
          child: Padding(
  ...
  SingleChildScrollView description() {
